  ...
  en: {
    ...
    translation: {
      ...
      features: {
        ...
        subtitle: "From training to multichannel deployment, REMOVED handles it.",
        items: {
      ...
      sidebar: { overview: "Overview", chatbot: "ChatBot", usage: "Usage", settings: "Settings", payment: "Payment", referEarn: "Refer & Earn" },
      ...
      pricing: {
        ...
        starter: { name: "Starter", desc: "Try REMOVED free" },
        ...
        free: { name: "Free", price: "$0", desc: "For exploring REMOVED", features: ["1 chatbot", "100 messages / mo", "1 channel", "Community support"] },
      ...
      overview: {
        ...
        subtitle: "Here's how REMOVED is growing your business.",
        leads: "Leads Captured",
        conversations: "Total Conversations",
        savings: "Estimated Savings",
        sentiment: "Customer Mood",
        activity: "Activity (Last 7 Days)",
        platforms: "Traffic by Platform",
        topTopics: "What Customers are Asking",
        moneySaved: "Money Saved",
        hoursSaved: "Hours Saved",
        roiNote: "Calculated based on human support time saved.",
        sentimentLabels: { happy: "Happy", neutral: "Neutral", unhappy: "Unhappy" }
      },
  ...
  bn: {
    ...
    translation: {
      ...
      features: {
        ...
        subtitle: "ট্রেনিং থেকে মাল্টি-চ্যানেল ডিপ্লয়মেন্ট — সব REMOVED-এ।",
        items: {
          train: { t: "যেকোনো ডেটা দিয়ে ট্রেইন", d: "ফাইল (PDF, DOCX, TXT), ওয়েবসাইট, টেক্সট এবং Q&A।" },
          channels: { t: "মাল্টি-চ্যানেল", d: "Facebook, WhatsApp, Instagram, Telegram, Slack — REMOVED-এ সব।" },
      ...
      sidebar: { overview: "ওভারভিউ", chatbot: "চ্যাটবট", usage: "ব্যবহার", settings: "সেটিংস", payment: "পেমেন্ট", referEarn: "রেফার ও আয়" },
      ...
      pricing: {
        ...
        starter: { name: "স্টার্টার", desc: "REMOVED ফ্রিতে ট্রাই করুন" },
        ...
        // Legacy keys kept for compatibility
        free: { name: "ফ্রি", price: "৳০", desc: "REMOVED এক্সপ্লোর করতে", features: ["১টি চ্যাটবট", "১০০ মেসেজ / মাস", "১টি চ্যানেল", "কমিউনিটি সাপোর্ট"] },
      ...
      overview: {
        ...
        subtitle: "আপনার ব্যবসায় REMOVED-এর পারফরম্যান্স একনজরে দেখে নিন।",
        leads: "সংগৃহীত লিড",
        conversations: "মোট আলাপচারিতা",
        savings: "আনুমানিক সাশ্রয়",
        sentiment: "কাস্টমার সন্তুষ্টি",
        activity: "অ্যাক্টিভিটি (গত ৭ দিন)",
        platforms: "প্ল্যাটফর্ম ভিত্তিক ট্রাফিক",
        topTopics: "সবচেয়ে বেশি জিজ্ঞাসিত প্রশ্ন",
        moneySaved: "টাকা সাশ্রয়",
        hoursSaved: "সময় সাশ্রয়",
        roiNote: "মানুষের সাপোর্ট টাইম কতটুকু বেঁচেছে তার ওপর ভিত্তি করে হিসাব করা।",
        sentimentLabels: { happy: "সন্তুষ্ট", neutral: "স্বাভাবিক", unhappy: "অসন্তুষ্ট" }
      },
