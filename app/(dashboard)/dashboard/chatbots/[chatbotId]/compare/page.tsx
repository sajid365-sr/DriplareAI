  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex gap-2">
        ...
        <Button onClick={run} disabled={busy} className="rounded-full px-6 bg-primary/80 hover:bg-primary" data-testid="compare-run">Compare</Button>
      </div>
      <div className="text-xs text-muted-foreground">Each comparison uses 2 AI messages from your quota</div>
    </div>
  );
}
