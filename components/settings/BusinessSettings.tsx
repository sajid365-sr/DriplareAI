      ...
      <div className="flex items-center gap-3 mb-6 relative z-10">
        ...
        <div>
          <h2 className="text-lg font-bold">
            {isBn ? "বিজনেস ROI সেটিংস" : "Business ROI Settings"}
          </h2>
          <p className="text-xs text-muted-foreground mt-0.5">
            {isBn ? "আপনার সেভিংস ক্যালকুলেশন কাস্টমাইজ করুন" : "Customize how your savings are calculated"}
          </p>
        </div>
      </div>
      ...
      <div className="space-y-6 relative z-10">
        <div className="space-y-3">
          <label className="text-sm font-semibold flex items-center gap-2">
            ...
            {isBn ? "প্রতি ঘণ্টায় সাপোর্ট খরচ" : "Estimated Human Support Cost (per hour)"}
          </label>
          ...
          <p className="text-[11px] text-muted-foreground flex items-start gap-1.5 mt-2 bg-muted/30 p-3 rounded-xl border border-border/50">
            ...
            {isBn 
              ? "এই খরচটি আপনার 'ওভারভিউ' পেজে টাকা সাশ্রয় (Money Saved) হিসাব করতে ব্যবহৃত হয়। এটি সাধারণত একজন কাস্টমার সাপোর্ট এজেন্টের গড় বেতন বা খরচ হওয়া উচিত।"
              : "This value is used to calculate your 'Money Saved' on the Overview page. It should represent the average hourly wage or cost of a human support agent."}
          </p>
        </div>
          ...
          >
            {saved ? (
              ...
              <>
                ...
                {isBn ? "সেভিংস আপডেট করুন" : "Update ROI Settings"}
              </>
            )}
          </Button>
        </div>
