  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-2xl">
        ...
        <h3 className="text-2xl font-bold mb-3">Earn Cash with the REMOVED Affiliate Program</h3>
        <p className="text-muted-foreground leading-relaxed mb-6">
          Soon you will be able to earn real commission for every paying customer you bring to REMOVED AI. 
